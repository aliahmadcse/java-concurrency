...
public class ForkJoinExample
{
  ...
  public static void runForkJoinExample()
  {
    ...
    ForkJoinExample.CalculatePrimeTask calculatePrimeTask =
            new ForkJoinExample.CalculatePrimeTask(inputNumbers, 0, inputNumbers.length - 1);
...
//      }
      ...
      int mid = (start + end) / 2;
      CalculatePrimeTask subTask1 = new CalculatePrimeTask(inputNumbers, start, mid);
      CalculatePrimeTask subTask2 = new CalculatePrimeTask(inputNumbers, mid + 1, end);
